...
const Upcard = ({ item }) => {
  return (
    <div
      class="relative w-[265px] h-[177px] rounded-[10px] font-[Poppins]"
      style={{ backgroundImage: `url(${presales_back})` }}
    >
      <div class="absolute ml-[7%] mt-[3%] w-[70%] h-[85%]">
        <p class="text-[18px] tracking-normal text-left font-[Inter]">Presales</p>
        <p class="text-[14px] tracking-normal text-left opacity-80 font-[Inter]">
          Browse The Best Upcoming Projects
        </p>
        <div class="absolute flex bottom-0 left-0 mb-[25px]">
          <p class="text-[14px] tracking-normal text-left text-[#F20CEC] mt-[2px]">
            Browse Presale
          </p>
          <svg
            width="24"
        ...
        <div class="absolute flex bottom-0 left-0">
          <p class="text-[14px] tracking-normal text-left text-[#F20CEC] mt-[2px]">
            Create Presale
          </p>
          <svg
