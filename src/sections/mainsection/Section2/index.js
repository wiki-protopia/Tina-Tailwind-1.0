  ...
  return (
    <div class="mt-[80px] overflow-hidden">
      <div class="lg:flex">
        ...
        {ismaxlg && <button class="flex w-[190px] h-[46px] rounded-[25px] bg-opacity-15 bg-[#F20CEC] object-right-top ml-auto">
          <svg
            width="32"
            height="32"
            viewBox="0 0 32 32"
      ...
      <div class="lg:flex">
        ...
        <p class="text-[18px] font-normal tracking-normal text-left leading-[27px] lg:w-[440px] lg:object-right-top ml-auto">
        ...
        {!ismaxlg && <button class="flex h-[46px] rounded-[25px] bg-[#F20CEC] lg:object-right-top lg:ml-auto">
          <svg
            width="32"
            height="32"
            viewBox="0 0 32 32"
          ...
          <p class="text-[12px] font-medium leading-[18px] tracking-normal text-center ml-[2px] mr-[4px] mt-[14px]">
            Create Launchpad
          </p>
        </button>}
      </div>
      <div class="mt-[20px] lg:flex">
        {mockdata.mainsection.upcarddata.map( item => (
            <Upcard key={item.id} item = {item}></Upcard>
        ))}
      </div>
      <div class="mt-[50px] lg:flex">
